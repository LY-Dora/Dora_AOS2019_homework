...
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    ...
    7c8f:	3b 75 f0             	cmp    -0x10(%ebp),%esi
...
insl(uint32_t port, void *addr, int cnt) {
    ...
    // we load in increasing order.
    for (; va < end_va; va += SECTSIZE, secno ++) {
    7d00:	03 35 f0 7d 00 00    	add    0x7df0,%esi
    7d06:	43                   	inc    %ebx
...
bootmain(void) {
    ...
    7d0f:	a1 f0 7d 00 00       	mov    0x7df0,%eax
    }
}
...
bootmain(void) {
    ...
    7d27:	e8 46 ff ff ff       	call   7c72 <readseg>

    // is this a valid ELF?
    if (ELFHDR->e_magic != ELF_MAGIC) {
    7d2c:	a1 ec 7d 00 00       	mov    0x7dec,%eax
    7d31:	81 38 7f 45 4c 46    	cmpl   $0x464c457f,(%eax)
    7d37:	75 39                	jne    7d72 <bootmain+0x63>
    ...
    7d39:	0f b7 70 2c          	movzwl 0x2c(%eax),%esi
    }
    ...
    7d40:	01 c3                	add    %eax,%ebx
    eph = ph + ELFHDR->e_phnum;
    7d42:	c1 e6 05             	shl    $0x5,%esi
    7d45:	01 de                	add    %ebx,%esi
    for (; ph < eph; ph ++) {
    7d47:	39 f3                	cmp    %esi,%ebx
    7d49:	73 18                	jae    7d63 <bootmain+0x54>
        readseg(ph->p_va & 0xFFFFFF, ph->p_memsz, ph->p_offset);
    7d4b:	8b 43 08             	mov    0x8(%ebx),%eax
    ...
    7d51:	83 c3 20             	add    $0x20,%ebx
        readseg(ph->p_va & 0xFFFFFF, ph->p_memsz, ph->p_offset);
    7d54:	8b 53 f4             	mov    -0xc(%ebx),%edx
    7d57:	25 ff ff ff 00       	and    $0xffffff,%eax
    7d5c:	e8 11 ff ff ff       	call   7c72 <readseg>
    7d61:	eb e4                	jmp    7d47 <bootmain+0x38>
    }
...
outw(uint16_t port, uint16_t data) {
    ...
    7d82:	eb fe                	jmp    7d82 <bootmain+0x73>
