...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 dc 0e 00 00       	call   80168b <main>
...
forkchild(const char *cur, char branch) {
  ...
  8015eb:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8015ee:	83 ec 0c             	sub    $0xc,%esp
  8015f1:	ff 75 08             	pushl  0x8(%ebp)
  8015f4:	e8 b7 f3 ff ff       	call   8009b0 <strlen>
  8015f9:	83 c4 10             	add    $0x10,%esp
  8015fc:	83 f8 03             	cmp    $0x3,%eax
  8015ff:	77 45                	ja     801646 <forkchild+0x64>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801601:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  801605:	83 ec 0c             	sub    $0xc,%esp
  801608:	50                   	push   %eax
  801609:	ff 75 08             	pushl  0x8(%ebp)
  80160c:	68 60 1b 80 00       	push   $0x801b60
  801611:	6a 05                	push   $0x5
  801613:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801616:	50                   	push   %eax
  801617:	e8 3e fe ff ff       	call   80145a <snprintf>
  80161c:	83 c4 20             	add    $0x20,%esp
    if (fork() == 0) {
  80161f:	e8 98 f2 ff ff       	call   8008bc <fork>
  801624:	85 c0                	test   %eax,%eax
  801626:	75 1f                	jne    801647 <forkchild+0x65>
        forktree(nxt);
  801628:	83 ec 0c             	sub    $0xc,%esp
  80162b:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80162e:	50                   	push   %eax
  80162f:	e8 15 00 00 00       	call   801649 <forktree>
  801634:	83 c4 10             	add    $0x10,%esp
        yield();
  801637:	e8 bd f2 ff ff       	call   8008f9 <yield>
        exit(0);
  80163c:	83 ec 0c             	sub    $0xc,%esp
  80163f:	6a 00                	push   $0x0
  801641:	e8 50 f2 ff ff       	call   800896 <exit>
void
forkchild(const char *cur, char branch) {
    char nxt[DEPTH + 1];
...
forktree(const char *cur) {
  ...
  80164c:	83 ec 08             	sub    $0x8,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80164f:	e8 c9 f2 ff ff       	call   80091d <getpid>
  801654:	83 ec 04             	sub    $0x4,%esp
  801657:	ff 75 08             	pushl  0x8(%ebp)
  80165a:	50                   	push   %eax
  80165b:	68 65 1b 80 00       	push   $0x801b65
  801660:	e8 70 ef ff ff       	call   8005d5 <cprintf>
  ...
  801670:	e8 6d ff ff ff       	call   8015e2 <forkchild>
  801675:	83 c4 10             	add    $0x10,%esp
    forkchild(cur, '1');
  801678:	83 ec 08             	sub    $0x8,%esp
  80167b:	6a 31                	push   $0x31
  80167d:	ff 75 08             	pushl  0x8(%ebp)
  801680:	e8 5d ff ff ff       	call   8015e2 <forkchild>
...
int
main(void) {
  80168b:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80168f:	83 e4 f0             	and    $0xfffffff0,%esp
  801692:	ff 71 fc             	pushl  -0x4(%ecx)
  801695:	55                   	push   %ebp
  ...
  80169f:	68 90 01 00 00       	push   $0x190
  8016a4:	68 78 1b 80 00       	push   $0x801b78
  8016a9:	e8 27 ef ff ff       	call   8005d5 <cprintf>
  8016ae:	83 c4 10             	add    $0x10,%esp
    sleep(SLEEP_TIME);
  8016b1:	83 ec 0c             	sub    $0xc,%esp
  8016b4:	68 90 01 00 00       	push   $0x190
  8016b9:	e8 91 f2 ff ff       	call   80094f <sleep>
  8016be:	83 c4 10             	add    $0x10,%esp
    forktree("");
  8016c1:	83 ec 0c             	sub    $0xc,%esp
  8016c4:	68 9e 1b 80 00       	push   $0x801b9e
  8016c9:	e8 7b ff ff ff       	call   801649 <forktree>
  8016ce:	83 c4 10             	add    $0x10,%esp
    return 0;
  8016d1:	b8 00 00 00 00       	mov    $0x0,%eax
}
  8016d6:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8016d9:	c9                   	leave  
  8016da:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016dd:	c3                   	ret    
