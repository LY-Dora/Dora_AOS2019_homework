...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 80 16 80 00       	push   $0x801680
  ...
  800057:	68 9a 16 80 00       	push   $0x80169a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 9c 16 80 00       	push   $0x80169c
  ...
  8000a5:	68 9a 16 80 00       	push   $0x80169a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 b8 16 80 00       	push   $0x8016b8
  ...
  80052a:	50                   	push   %eax
  80052b:	68 c3 16 80 00       	push   $0x8016c3
  ...
  800541:	50                   	push   %eax
  800542:	68 d5 16 80 00       	push   $0x8016d5
  ...
  800558:	50                   	push   %eax
  800559:	68 e8 16 80 00       	push   $0x8016e8
  ...
  80056f:	50                   	push   %eax
  800570:	68 fb 16 80 00       	push   $0x8016fb
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 0e 17 80 00       	push   $0x80170e
  ...
  800759:	68 15 17 80 00       	push   $0x801715
  80075e:	6a 1a                	push   $0x1a
  800760:	68 2f 17 80 00       	push   $0x80172f
  ...
  800772:	68 41 17 80 00       	push   $0x801741
  ...
  80078d:	68 49 17 80 00       	push   $0x801749
  800792:	6a 1d                	push   $0x1d
  800794:	68 2f 17 80 00       	push   $0x80172f
...
exit(int error_code) {
  ...
  8008ad:	68 64 17 80 00       	push   $0x801764
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 84 19 80 00       	add    $0x801984,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 a8 19 80 00 	mov    0x8019a8(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 9e 19 80 00       	push   $0x80199e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be a1 19 80 00       	mov    $0x8019a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015f3:	e8 25 f3 ff ff       	call   80091d <getpid>
  8015f8:	83 ec 08             	sub    $0x8,%esp
  8015fb:	50                   	push   %eax
  8015fc:	68 00 1b 80 00       	push   $0x801b00
  801601:	e8 cf ef ff ff       	call   8005d5 <cprintf>
  801606:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 5; i ++) {
  801609:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801610:	eb 22                	jmp    801634 <main+0x52>
        yield();
  801612:	e8 e2 f2 ff ff       	call   8008f9 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801617:	e8 01 f3 ff ff       	call   80091d <getpid>
  80161c:	83 ec 04             	sub    $0x4,%esp
  80161f:	ff 75 f4             	pushl  -0xc(%ebp)
  801622:	50                   	push   %eax
  801623:	68 1c 1b 80 00       	push   $0x801b1c
  801628:	e8 a8 ef ff ff       	call   8005d5 <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  801630:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801634:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  801638:	7e d8                	jle    801612 <main+0x30>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  80163a:	e8 de f2 ff ff       	call   80091d <getpid>
  80163f:	83 ec 08             	sub    $0x8,%esp
  801642:	50                   	push   %eax
  801643:	68 3f 1b 80 00       	push   $0x801b3f
  801648:	e8 88 ef ff ff       	call   8005d5 <cprintf>
  80164d:	83 c4 10             	add    $0x10,%esp
    cprintf("yield pass.\n");
  801650:	83 ec 0c             	sub    $0xc,%esp
  801653:	68 58 1b 80 00       	push   $0x801b58
  801658:	e8 78 ef ff ff       	call   8005d5 <cprintf>
  80165d:	83 c4 10             	add    $0x10,%esp
    return 0;
  801660:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801665:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801668:	c9                   	leave  
  801669:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80166c:	c3                   	ret    
