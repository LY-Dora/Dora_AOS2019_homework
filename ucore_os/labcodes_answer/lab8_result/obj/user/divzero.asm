...
main(void) {
  ...
  8015f0:	83 ec 04             	sub    $0x4,%esp
    cprintf("value is %d.\n", 1 / zero);
  8015f3:	8b 0d 48 21 80 00    	mov    0x802148,%ecx
  8015f9:	b8 01 00 00 00       	mov    $0x1,%eax
  8015fe:	99                   	cltd   
  8015ff:	f7 f9                	idiv   %ecx
  801601:	83 ec 08             	sub    $0x8,%esp
  801604:	50                   	push   %eax
  801605:	68 c0 1a 80 00       	push   $0x801ac0
  80160a:	e8 c6 ef ff ff       	call   8005d5 <cprintf>
  80160f:	83 c4 10             	add    $0x10,%esp
    panic("FAIL: T.T\n");
  801612:	83 ec 04             	sub    $0x4,%esp
  801615:	68 ce 1a 80 00       	push   $0x801ace
  80161a:	6a 09                	push   $0x9
  80161c:	68 d9 1a 80 00       	push   $0x801ad9
  801621:	e8 fa e9 ff ff       	call   800020 <__panic>
