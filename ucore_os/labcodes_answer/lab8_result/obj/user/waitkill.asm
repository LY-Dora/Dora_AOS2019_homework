...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 80 17 80 00       	push   $0x801780
  ...
  800057:	68 9a 17 80 00       	push   $0x80179a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 9c 17 80 00       	push   $0x80179c
  ...
  8000a5:	68 9a 17 80 00       	push   $0x80179a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 b8 17 80 00       	push   $0x8017b8
  ...
  80052a:	50                   	push   %eax
  80052b:	68 c3 17 80 00       	push   $0x8017c3
  ...
  800541:	50                   	push   %eax
  800542:	68 d5 17 80 00       	push   $0x8017d5
  ...
  800558:	50                   	push   %eax
  800559:	68 e8 17 80 00       	push   $0x8017e8
  ...
  80056f:	50                   	push   %eax
  800570:	68 fb 17 80 00       	push   $0x8017fb
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 0e 18 80 00       	push   $0x80180e
  ...
  800759:	68 15 18 80 00       	push   $0x801815
  80075e:	6a 1a                	push   $0x1a
  800760:	68 2f 18 80 00       	push   $0x80182f
  ...
  800772:	68 41 18 80 00       	push   $0x801841
  ...
  80078d:	68 49 18 80 00       	push   $0x801849
  800792:	6a 1d                	push   $0x1d
  800794:	68 2f 18 80 00       	push   $0x80182f
  ...
  8007aa:	e8 f0 0e 00 00       	call   80169f <main>
...
exit(int error_code) {
  ...
  8008ad:	68 64 18 80 00       	push   $0x801864
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 84 1a 80 00       	add    $0x801a84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 a8 1a 80 00 	mov    0x801aa8(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 9e 1a 80 00       	push   $0x801a9e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be a1 1a 80 00       	mov    $0x801aa1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8015e5:	83 ec 08             	sub    $0x8,%esp
    yield();
  8015e8:	e8 0c f3 ff ff       	call   8008f9 <yield>
    yield();
  8015ed:	e8 07 f3 ff ff       	call   8008f9 <yield>
    yield();
  8015f2:	e8 02 f3 ff ff       	call   8008f9 <yield>
    yield();
  8015f7:	e8 fd f2 ff ff       	call   8008f9 <yield>
    yield();
  8015fc:	e8 f8 f2 ff ff       	call   8008f9 <yield>
    yield();
  801601:	e8 f3 f2 ff ff       	call   8008f9 <yield>
}
  801606:	90                   	nop
  801607:	c9                   	leave  
  801608:	c3                   	ret    
...
loop(void) {
  ...
  801612:	68 00 1c 80 00       	push   $0x801c00
  801617:	e8 b9 ef ff ff       	call   8005d5 <cprintf>
  80161c:	83 c4 10             	add    $0x10,%esp
    while (1);
  80161f:	eb fe                	jmp    80161f <loop+0x16>
...
work(void) {
  ...
  80162a:	68 0a 1c 80 00       	push   $0x801c0a
  80162f:	e8 a1 ef ff ff       	call   8005d5 <cprintf>
  801634:	83 c4 10             	add    $0x10,%esp
    do_yield();
  801637:	e8 a6 ff ff ff       	call   8015e2 <do_yield>
    if (kill(parent) == 0) {
  80163c:	a1 48 21 80 00       	mov    0x802148,%eax
  801641:	83 ec 0c             	sub    $0xc,%esp
  801644:	50                   	push   %eax
  801645:	e8 bd f2 ff ff       	call   800907 <kill>
  80164a:	83 c4 10             	add    $0x10,%esp
  80164d:	85 c0                	test   %eax,%eax
  80164f:	75 44                	jne    801695 <work+0x74>
        cprintf("kill parent ok.\n");
  801651:	83 ec 0c             	sub    $0xc,%esp
  801654:	68 14 1c 80 00       	push   $0x801c14
  801659:	e8 77 ef ff ff       	call   8005d5 <cprintf>
  80165e:	83 c4 10             	add    $0x10,%esp
        do_yield();
  801661:	e8 7c ff ff ff       	call   8015e2 <do_yield>
        if (kill(pid1) == 0) {
  801666:	a1 50 21 80 00       	mov    0x802150,%eax
  80166b:	83 ec 0c             	sub    $0xc,%esp
  80166e:	50                   	push   %eax
  80166f:	e8 93 f2 ff ff       	call   800907 <kill>
  801674:	83 c4 10             	add    $0x10,%esp
  801677:	85 c0                	test   %eax,%eax
  801679:	75 1a                	jne    801695 <work+0x74>
            cprintf("kill child1 ok.\n");
  80167b:	83 ec 0c             	sub    $0xc,%esp
  80167e:	68 25 1c 80 00       	push   $0x801c25
  801683:	e8 4d ef ff ff       	call   8005d5 <cprintf>
  801688:	83 c4 10             	add    $0x10,%esp
            exit(0);
  80168b:	83 ec 0c             	sub    $0xc,%esp
  80168e:	6a 00                	push   $0x0
  801690:	e8 01 f2 ff ff       	call   800896 <exit>
        }
    }
    exit(-1);
  801695:	83 ec 0c             	sub    $0xc,%esp
  801698:	6a ff                	push   $0xffffffff
  80169a:	e8 f7 f1 ff ff       	call   800896 <exit>
...
int
main(void) {
  80169f:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8016a3:	83 e4 f0             	and    $0xfffffff0,%esp
  8016a6:	ff 71 fc             	pushl  -0x4(%ecx)
  8016a9:	55                   	push   %ebp
  8016aa:	89 e5                	mov    %esp,%ebp
  8016ac:	51                   	push   %ecx
  8016ad:	83 ec 04             	sub    $0x4,%esp
    parent = getpid();
  8016b0:	e8 68 f2 ff ff       	call   80091d <getpid>
  8016b5:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  8016ba:	e8 fd f1 ff ff       	call   8008bc <fork>
  8016bf:	a3 50 21 80 00       	mov    %eax,0x802150
  8016c4:	a1 50 21 80 00       	mov    0x802150,%eax
  8016c9:	85 c0                	test   %eax,%eax
  8016cb:	75 05                	jne    8016d2 <main+0x33>
        loop();
  8016cd:	e8 37 ff ff ff       	call   801609 <loop>
    }

    assert(pid1 > 0);
  8016d2:	a1 50 21 80 00       	mov    0x802150,%eax
  8016d7:	85 c0                	test   %eax,%eax
  8016d9:	7f 16                	jg     8016f1 <main+0x52>
  8016db:	68 36 1c 80 00       	push   $0x801c36
  8016e0:	68 3f 1c 80 00       	push   $0x801c3f
  8016e5:	6a 2c                	push   $0x2c
  8016e7:	68 54 1c 80 00       	push   $0x801c54
  8016ec:	e8 2f e9 ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  8016f1:	e8 c6 f1 ff ff       	call   8008bc <fork>
  8016f6:	a3 4c 21 80 00       	mov    %eax,0x80214c
  8016fb:	a1 4c 21 80 00       	mov    0x80214c,%eax
  801700:	85 c0                	test   %eax,%eax
  801702:	75 05                	jne    801709 <main+0x6a>
        work();
  801704:	e8 18 ff ff ff       	call   801621 <work>
    }
    if (pid2 > 0) {
  801709:	a1 4c 21 80 00       	mov    0x80214c,%eax
  80170e:	85 c0                	test   %eax,%eax
  801710:	7e 3a                	jle    80174c <main+0xad>
        cprintf("wait child 1.\n");
  801712:	83 ec 0c             	sub    $0xc,%esp
  801715:	68 64 1c 80 00       	push   $0x801c64
  80171a:	e8 b6 ee ff ff       	call   8005d5 <cprintf>
  80171f:	83 c4 10             	add    $0x10,%esp
        waitpid(pid1, NULL);
  801722:	a1 50 21 80 00       	mov    0x802150,%eax
  801727:	83 ec 08             	sub    $0x8,%esp
  80172a:	6a 00                	push   $0x0
  80172c:	50                   	push   %eax
  80172d:	e8 ae f1 ff ff       	call   8008e0 <waitpid>
  801732:	83 c4 10             	add    $0x10,%esp
        panic("waitpid %d returns\n", pid1);
  801735:	a1 50 21 80 00       	mov    0x802150,%eax
  80173a:	50                   	push   %eax
  80173b:	68 73 1c 80 00       	push   $0x801c73
  801740:	6a 34                	push   $0x34
  801742:	68 54 1c 80 00       	push   $0x801c54
  801747:	e8 d4 e8 ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  80174c:	a1 50 21 80 00       	mov    0x802150,%eax
  801751:	83 ec 0c             	sub    $0xc,%esp
  801754:	50                   	push   %eax
  801755:	e8 ad f1 ff ff       	call   800907 <kill>
  80175a:	83 c4 10             	add    $0x10,%esp
    }
    panic("FAIL: T.T\n");
  80175d:	83 ec 04             	sub    $0x4,%esp
  801760:	68 87 1c 80 00       	push   $0x801c87
  801765:	6a 39                	push   $0x39
  801767:	68 54 1c 80 00       	push   $0x801c54
  80176c:	e8 af e8 ff ff       	call   800020 <__panic>
