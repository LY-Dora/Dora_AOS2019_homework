...
obj/__user_sleep.out：     文件格式 elf32-i386
...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 86 0e 00 00       	call   801635 <main>
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  801621:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801625:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801629:	7e cd                	jle    8015f8 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  ...
  801630:	e8 61 f2 ff ff       	call   800896 <exit>
...
int
main(void) {
  801635:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801639:	83 e4 f0             	and    $0xfffffff0,%esp
  80163c:	ff 71 fc             	pushl  -0x4(%ecx)
  80163f:	55                   	push   %ebp
  801640:	89 e5                	mov    %esp,%ebp
  801642:	51                   	push   %ecx
  801643:	83 ec 14             	sub    $0x14,%esp
    unsigned int time = gettime_msec();
  801646:	e8 1a f3 ff ff       	call   800965 <gettime_msec>
  80164b:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80164e:	e8 69 f2 ff ff       	call   8008bc <fork>
  801653:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801656:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80165a:	75 0e                	jne    80166a <main+0x35>
        sleepy(pid1);
  80165c:	83 ec 0c             	sub    $0xc,%esp
  80165f:	ff 75 f0             	pushl  -0x10(%ebp)
  801662:	e8 7b ff ff ff       	call   8015e2 <sleepy>
  ...
  801674:	e8 67 f2 ff ff       	call   8008e0 <waitpid>
  801679:	83 c4 10             	add    $0x10,%esp
  80167c:	85 c0                	test   %eax,%eax
  80167e:	75 07                	jne    801687 <main+0x52>
  801680:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801683:	85 c0                	test   %eax,%eax
  801685:	74 16                	je     80169d <main+0x68>
  801687:	68 78 1b 80 00       	push   $0x801b78
  80168c:	68 a9 1b 80 00       	push   $0x801ba9
  801691:	6a 17                	push   $0x17
  801693:	68 be 1b 80 00       	push   $0x801bbe
  801698:	e8 83 e9 ff ff       	call   800020 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  80169d:	e8 c3 f2 ff ff       	call   800965 <gettime_msec>
  8016a2:	2b 45 f4             	sub    -0xc(%ebp),%eax
  8016a5:	83 ec 08             	sub    $0x8,%esp
  8016a8:	50                   	push   %eax
  8016a9:	68 cb 1b 80 00       	push   $0x801bcb
  8016ae:	e8 22 ef ff ff       	call   8005d5 <cprintf>
  8016b3:	83 c4 10             	add    $0x10,%esp
    cprintf("sleep pass.\n");
  8016b6:	83 ec 0c             	sub    $0xc,%esp
  8016b9:	68 dc 1b 80 00       	push   $0x801bdc
  8016be:	e8 12 ef ff ff       	call   8005d5 <cprintf>
  ...
  8016ce:	c9                   	leave  
  8016cf:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016d2:	c3                   	ret    
