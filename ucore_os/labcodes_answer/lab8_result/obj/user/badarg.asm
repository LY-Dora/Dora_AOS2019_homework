...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 00 17 80 00       	push   $0x801700
  ...
  800057:	68 1a 17 80 00       	push   $0x80171a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 1c 17 80 00       	push   $0x80171c
  ...
  8000a5:	68 1a 17 80 00       	push   $0x80171a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 38 17 80 00       	push   $0x801738
  ...
  80052a:	50                   	push   %eax
  80052b:	68 43 17 80 00       	push   $0x801743
  ...
  800541:	50                   	push   %eax
  800542:	68 55 17 80 00       	push   $0x801755
  ...
  800558:	50                   	push   %eax
  800559:	68 68 17 80 00       	push   $0x801768
  ...
  80056f:	50                   	push   %eax
  800570:	68 7b 17 80 00       	push   $0x80177b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 8e 17 80 00       	push   $0x80178e
  ...
  800759:	68 95 17 80 00       	push   $0x801795
  80075e:	6a 1a                	push   $0x1a
  800760:	68 af 17 80 00       	push   $0x8017af
  ...
  800772:	68 c1 17 80 00       	push   $0x8017c1
  ...
  80078d:	68 c9 17 80 00       	push   $0x8017c9
  800792:	6a 1d                	push   $0x1d
  800794:	68 af 17 80 00       	push   $0x8017af
...
exit(int error_code) {
  ...
  8008ad:	68 e4 17 80 00       	push   $0x8017e4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 04 1a 80 00       	add    $0x801a04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 28 1a 80 00 	mov    0x801a28(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 1e 1a 80 00       	push   $0x801a1e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be 21 1a 80 00       	mov    $0x801a21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015f0:	83 ec 14             	sub    $0x14,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8015f3:	e8 c4 f2 ff ff       	call   8008bc <fork>
  8015f8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  8015fb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  8015ff:	75 35                	jne    801636 <main+0x54>
        cprintf("fork ok.\n");
  801601:	83 ec 0c             	sub    $0xc,%esp
  801604:	68 80 1b 80 00       	push   $0x801b80
  801609:	e8 c7 ef ff ff       	call   8005d5 <cprintf>
  80160e:	83 c4 10             	add    $0x10,%esp
        int i;
        for (i = 0; i < 10; i ++) {
  801611:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801618:	eb 09                	jmp    801623 <main+0x41>
            yield();
  80161a:	e8 da f2 ff ff       	call   8008f9 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  80161f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801623:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801627:	7e f1                	jle    80161a <main+0x38>
            yield();
        }
        exit(0xbeaf);
  801629:	83 ec 0c             	sub    $0xc,%esp
  80162c:	68 af be 00 00       	push   $0xbeaf
  801631:	e8 60 f2 ff ff       	call   800896 <exit>
    }
    assert(pid > 0);
  801636:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80163a:	7f 16                	jg     801652 <main+0x70>
  80163c:	68 8a 1b 80 00       	push   $0x801b8a
  801641:	68 92 1b 80 00       	push   $0x801b92
  801646:	6a 0f                	push   $0xf
  801648:	68 a7 1b 80 00       	push   $0x801ba7
  80164d:	e8 ce e9 ff ff       	call   800020 <__panic>
    assert(waitpid(-1, NULL) != 0);
  801652:	83 ec 08             	sub    $0x8,%esp
  801655:	6a 00                	push   $0x0
  801657:	6a ff                	push   $0xffffffff
  801659:	e8 82 f2 ff ff       	call   8008e0 <waitpid>
  80165e:	83 c4 10             	add    $0x10,%esp
  801661:	85 c0                	test   %eax,%eax
  801663:	75 16                	jne    80167b <main+0x99>
  801665:	68 b5 1b 80 00       	push   $0x801bb5
  80166a:	68 92 1b 80 00       	push   $0x801b92
  80166f:	6a 10                	push   $0x10
  801671:	68 a7 1b 80 00       	push   $0x801ba7
  801676:	e8 a5 e9 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  80167b:	83 ec 08             	sub    $0x8,%esp
  80167e:	68 00 00 00 c0       	push   $0xc0000000
  801683:	ff 75 f0             	pushl  -0x10(%ebp)
  801686:	e8 55 f2 ff ff       	call   8008e0 <waitpid>
  80168b:	83 c4 10             	add    $0x10,%esp
  80168e:	85 c0                	test   %eax,%eax
  801690:	75 16                	jne    8016a8 <main+0xc6>
  801692:	68 cc 1b 80 00       	push   $0x801bcc
  801697:	68 92 1b 80 00       	push   $0x801b92
  80169c:	6a 11                	push   $0x11
  80169e:	68 a7 1b 80 00       	push   $0x801ba7
  8016a3:	e8 78 e9 ff ff       	call   800020 <__panic>
  ...
  8016b2:	e8 29 f2 ff ff       	call   8008e0 <waitpid>
  8016b7:	83 c4 10             	add    $0x10,%esp
  8016ba:	85 c0                	test   %eax,%eax
  8016bc:	75 0a                	jne    8016c8 <main+0xe6>
  8016be:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8016c1:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8016c6:	74 16                	je     8016de <main+0xfc>
  8016c8:	68 f4 1b 80 00       	push   $0x801bf4
  8016cd:	68 92 1b 80 00       	push   $0x801b92
  8016d2:	6a 12                	push   $0x12
  8016d4:	68 a7 1b 80 00       	push   $0x801ba7
  8016d9:	e8 42 e9 ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  8016de:	83 ec 0c             	sub    $0xc,%esp
  8016e1:	68 29 1c 80 00       	push   $0x801c29
  8016e6:	e8 ea ee ff ff       	call   8005d5 <cprintf>
  8016eb:	83 c4 10             	add    $0x10,%esp
    return 0;
  8016ee:	b8 00 00 00 00       	mov    $0x0,%eax
}
  8016f3:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8016f6:	c9                   	leave  
  8016f7:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016fa:	c3                   	ret    
