...
obj/__user_sleepkill.out：     文件格式 elf32-i386
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 a0 16 80 00       	push   $0x8016a0
  ...
  800057:	68 ba 16 80 00       	push   $0x8016ba
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 bc 16 80 00       	push   $0x8016bc
  ...
  8000a5:	68 ba 16 80 00       	push   $0x8016ba
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 d8 16 80 00       	push   $0x8016d8
  ...
  80052a:	50                   	push   %eax
  80052b:	68 e3 16 80 00       	push   $0x8016e3
  ...
  800541:	50                   	push   %eax
  800542:	68 f5 16 80 00       	push   $0x8016f5
  ...
  800558:	50                   	push   %eax
  800559:	68 08 17 80 00       	push   $0x801708
  ...
  80056f:	50                   	push   %eax
  800570:	68 1b 17 80 00       	push   $0x80171b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 2e 17 80 00       	push   $0x80172e
  ...
  800759:	68 35 17 80 00       	push   $0x801735
  80075e:	6a 1a                	push   $0x1a
  800760:	68 4f 17 80 00       	push   $0x80174f
  ...
  800772:	68 61 17 80 00       	push   $0x801761
  ...
  80078d:	68 69 17 80 00       	push   $0x801769
  800792:	6a 1d                	push   $0x1d
  800794:	68 4f 17 80 00       	push   $0x80174f
...
exit(int error_code) {
  ...
  8008ad:	68 84 17 80 00       	push   $0x801784
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 a4 19 80 00       	add    $0x8019a4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 c8 19 80 00 	mov    0x8019c8(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 be 19 80 00       	push   $0x8019be
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be c1 19 80 00       	mov    $0x8019c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015ff:	75 1a                	jne    80161b <main+0x39>
        sleep(~0);
  801601:	83 ec 0c             	sub    $0xc,%esp
  801604:	6a ff                	push   $0xffffffff
  801606:	e8 44 f3 ff ff       	call   80094f <sleep>
  80160b:	83 c4 10             	add    $0x10,%esp
        exit(0xdead);
  80160e:	83 ec 0c             	sub    $0xc,%esp
  801611:	68 ad de 00 00       	push   $0xdead
  801616:	e8 7b f2 ff ff       	call   800896 <exit>
    }
    assert(pid > 0);
  80161b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80161f:	7f 16                	jg     801637 <main+0x55>
  801621:	68 20 1b 80 00       	push   $0x801b20
  801626:	68 28 1b 80 00       	push   $0x801b28
  80162b:	6a 0b                	push   $0xb
  80162d:	68 3d 1b 80 00       	push   $0x801b3d
  801632:	e8 e9 e9 ff ff       	call   800020 <__panic>

    sleep(100);
  801637:	83 ec 0c             	sub    $0xc,%esp
  80163a:	6a 64                	push   $0x64
  80163c:	e8 0e f3 ff ff       	call   80094f <sleep>
  801641:	83 c4 10             	add    $0x10,%esp
    assert(kill(pid) == 0);
  801644:	83 ec 0c             	sub    $0xc,%esp
  801647:	ff 75 f4             	pushl  -0xc(%ebp)
  80164a:	e8 b8 f2 ff ff       	call   800907 <kill>
  80164f:	83 c4 10             	add    $0x10,%esp
  801652:	85 c0                	test   %eax,%eax
  801654:	74 16                	je     80166c <main+0x8a>
  801656:	68 4e 1b 80 00       	push   $0x801b4e
  80165b:	68 28 1b 80 00       	push   $0x801b28
  801660:	6a 0e                	push   $0xe
  801662:	68 3d 1b 80 00       	push   $0x801b3d
  801667:	e8 b4 e9 ff ff       	call   800020 <__panic>
    cprintf("sleepkill pass.\n");
  80166c:	83 ec 0c             	sub    $0xc,%esp
  80166f:	68 5d 1b 80 00       	push   $0x801b5d
  801674:	e8 5c ef ff ff       	call   8005d5 <cprintf>
  801679:	83 c4 10             	add    $0x10,%esp
    return 0;
  80167c:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801681:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801684:	c9                   	leave  
  801685:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801688:	c3                   	ret    
