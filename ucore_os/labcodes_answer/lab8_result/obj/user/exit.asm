...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 40 17 80 00       	push   $0x801740
  ...
  800057:	68 5a 17 80 00       	push   $0x80175a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 5c 17 80 00       	push   $0x80175c
  ...
  8000a5:	68 5a 17 80 00       	push   $0x80175a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 78 17 80 00       	push   $0x801778
  ...
  80052a:	50                   	push   %eax
  80052b:	68 83 17 80 00       	push   $0x801783
  ...
  800541:	50                   	push   %eax
  800542:	68 95 17 80 00       	push   $0x801795
  ...
  800558:	50                   	push   %eax
  800559:	68 a8 17 80 00       	push   $0x8017a8
  ...
  80056f:	50                   	push   %eax
  800570:	68 bb 17 80 00       	push   $0x8017bb
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 ce 17 80 00       	push   $0x8017ce
  ...
  800759:	68 d5 17 80 00       	push   $0x8017d5
  80075e:	6a 1a                	push   $0x1a
  800760:	68 ef 17 80 00       	push   $0x8017ef
  ...
  800772:	68 01 18 80 00       	push   $0x801801
  ...
  80078d:	68 09 18 80 00       	push   $0x801809
  800792:	6a 1d                	push   $0x1d
  800794:	68 ef 17 80 00       	push   $0x8017ef
...
exit(int error_code) {
  ...
  8008ad:	68 24 18 80 00       	push   $0x801824
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 44 1a 80 00       	add    $0x801a44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 68 1a 80 00 	mov    0x801a68(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 5e 1a 80 00       	push   $0x801a5e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be 61 1a 80 00       	mov    $0x801a61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015f6:	68 c0 1b 80 00       	push   $0x801bc0
  8015fb:	e8 d5 ef ff ff       	call   8005d5 <cprintf>
  801600:	83 c4 10             	add    $0x10,%esp
    if ((pid = fork()) == 0) {
  801603:	e8 b4 f2 ff ff       	call   8008bc <fork>
  801608:	89 45 f4             	mov    %eax,-0xc(%ebp)
  80160b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80160f:	75 41                	jne    801652 <main+0x70>
        cprintf("I am the child.\n");
  801611:	83 ec 0c             	sub    $0xc,%esp
  801614:	68 e7 1b 80 00       	push   $0x801be7
  801619:	e8 b7 ef ff ff       	call   8005d5 <cprintf>
  80161e:	83 c4 10             	add    $0x10,%esp
        yield();
  801621:	e8 d3 f2 ff ff       	call   8008f9 <yield>
        yield();
  801626:	e8 ce f2 ff ff       	call   8008f9 <yield>
        yield();
  80162b:	e8 c9 f2 ff ff       	call   8008f9 <yield>
        yield();
  801630:	e8 c4 f2 ff ff       	call   8008f9 <yield>
        yield();
  801635:	e8 bf f2 ff ff       	call   8008f9 <yield>
        yield();
  80163a:	e8 ba f2 ff ff       	call   8008f9 <yield>
        yield();
  80163f:	e8 b5 f2 ff ff       	call   8008f9 <yield>
        exit(magic);
  801644:	a1 10 20 80 00       	mov    0x802010,%eax
  801649:	83 ec 0c             	sub    $0xc,%esp
  80164c:	50                   	push   %eax
  80164d:	e8 44 f2 ff ff       	call   800896 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801652:	83 ec 08             	sub    $0x8,%esp
  801655:	ff 75 f4             	pushl  -0xc(%ebp)
  801658:	68 f8 1b 80 00       	push   $0x801bf8
  80165d:	e8 73 ef ff ff       	call   8005d5 <cprintf>
  801662:	83 c4 10             	add    $0x10,%esp
    }
    assert(pid > 0);
  801665:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801669:	7f 16                	jg     801681 <main+0x9f>
  80166b:	68 1a 1c 80 00       	push   $0x801c1a
  801670:	68 22 1c 80 00       	push   $0x801c22
  801675:	6a 18                	push   $0x18
  801677:	68 37 1c 80 00       	push   $0x801c37
  80167c:	e8 9f e9 ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801681:	83 ec 0c             	sub    $0xc,%esp
  801684:	68 44 1c 80 00       	push   $0x801c44
  801689:	e8 47 ef ff ff       	call   8005d5 <cprintf>
  ...
  80169b:	e8 40 f2 ff ff       	call   8008e0 <waitpid>
  8016a0:	83 c4 10             	add    $0x10,%esp
  8016a3:	85 c0                	test   %eax,%eax
  8016a5:	75 0c                	jne    8016b3 <main+0xd1>
  8016a7:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8016aa:	a1 10 20 80 00       	mov    0x802010,%eax
  8016af:	39 c2                	cmp    %eax,%edx
  8016b1:	74 16                	je     8016c9 <main+0xe7>
  8016b3:	68 64 1c 80 00       	push   $0x801c64
  8016b8:	68 22 1c 80 00       	push   $0x801c22
  8016bd:	6a 1b                	push   $0x1b
  8016bf:	68 37 1c 80 00       	push   $0x801c37
  8016c4:	e8 57 e9 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8016c9:	83 ec 08             	sub    $0x8,%esp
  8016cc:	8d 45 f0             	lea    -0x10(%ebp),%eax
  8016cf:	50                   	push   %eax
  8016d0:	ff 75 f4             	pushl  -0xc(%ebp)
  8016d3:	e8 08 f2 ff ff       	call   8008e0 <waitpid>
  8016d8:	83 c4 10             	add    $0x10,%esp
  8016db:	85 c0                	test   %eax,%eax
  8016dd:	74 09                	je     8016e8 <main+0x106>
  8016df:	e8 e5 f1 ff ff       	call   8008c9 <wait>
  8016e4:	85 c0                	test   %eax,%eax
  8016e6:	75 16                	jne    8016fe <main+0x11c>
  8016e8:	68 90 1c 80 00       	push   $0x801c90
  8016ed:	68 22 1c 80 00       	push   $0x801c22
  8016f2:	6a 1c                	push   $0x1c
  8016f4:	68 37 1c 80 00       	push   $0x801c37
  8016f9:	e8 22 e9 ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8016fe:	83 ec 08             	sub    $0x8,%esp
  801701:	ff 75 f4             	pushl  -0xc(%ebp)
  801704:	68 b8 1c 80 00       	push   $0x801cb8
  801709:	e8 c7 ee ff ff       	call   8005d5 <cprintf>
  80170e:	83 c4 10             	add    $0x10,%esp

    cprintf("exit pass.\n");
  801711:	83 ec 0c             	sub    $0xc,%esp
  801714:	68 c8 1c 80 00       	push   $0x801cc8
  801719:	e8 b7 ee ff ff       	call   8005d5 <cprintf>
  80171e:	83 c4 10             	add    $0x10,%esp
    return 0;
  801721:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801726:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801729:	c9                   	leave  
  80172a:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80172d:	c3                   	ret    
