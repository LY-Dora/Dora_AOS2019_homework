...
main(void) {
  ...
  8015f6:	68 60 1b 80 00       	push   $0x801b60
  8015fb:	e8 d5 ef ff ff       	call   8005d5 <cprintf>
  801600:	83 c4 10             	add    $0x10,%esp
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801603:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80160a:	eb 26                	jmp    801632 <main+0x50>
        if (bigarray[i] != 0) {
  80160c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80160f:	8b 04 85 60 21 80 00 	mov    0x802160(,%eax,4),%eax
  801616:	85 c0                	test   %eax,%eax
  801618:	74 14                	je     80162e <main+0x4c>
            panic("bigarray[%d] isn't cleared!\n", i);
  80161a:	ff 75 f4             	pushl  -0xc(%ebp)
  80161d:	68 80 1b 80 00       	push   $0x801b80
  801622:	6a 0e                	push   $0xe
  801624:	68 9d 1b 80 00       	push   $0x801b9d
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80162e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801632:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  801639:	7e d1                	jle    80160c <main+0x2a>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
  ...
  801642:	eb 11                	jmp    801655 <main+0x73>
        bigarray[i] = i;
  801644:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801647:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80164a:	89 14 85 60 21 80 00 	mov    %edx,0x802160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801651:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801655:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  80165c:	7e e6                	jle    801644 <main+0x62>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80165e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801665:	eb 29                	jmp    801690 <main+0xae>
        if (bigarray[i] != i) {
  801667:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80166a:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  ...
  80167b:	68 ac 1b 80 00       	push   $0x801bac
  801680:	6a 16                	push   $0x16
  801682:	68 9d 1b 80 00       	push   $0x801b9d
  801687:	e8 94 e9 ff ff       	call   800020 <__panic>
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80168c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801690:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  801697:	7e ce                	jle    801667 <main+0x85>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  80169c:	68 d4 1b 80 00       	push   $0x801bd4
  8016a1:	e8 2f ef ff ff       	call   8005d5 <cprintf>
  8016a6:	83 c4 10             	add    $0x10,%esp
    cprintf("testbss may pass.\n");
  8016a9:	83 ec 0c             	sub    $0xc,%esp
  8016ac:	68 07 1c 80 00       	push   $0x801c07
  8016b1:	e8 1f ef ff ff       	call   8005d5 <cprintf>
  8016b6:	83 c4 10             	add    $0x10,%esp

    bigarray[ARRAYSIZE + 1024] = 0;
  8016b9:	c7 05 60 31 c0 00 00 	movl   $0x0,0xc03160
  8016c0:	00 00 00 
    asm volatile ("int $0x14");
  8016c3:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8016c5:	83 ec 04             	sub    $0x4,%esp
  8016c8:	68 1a 1c 80 00       	push   $0x801c1a
  8016cd:	6a 1f                	push   $0x1f
  8016cf:	68 9d 1b 80 00       	push   $0x801b9d
  8016d4:	e8 47 e9 ff ff       	call   800020 <__panic>
