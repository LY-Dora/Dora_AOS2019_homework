...
main(void) {
  ...
  8015f0:	83 ec 04             	sub    $0x4,%esp
    asm volatile("int $14");
  8015f3:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8015f5:	83 ec 04             	sub    $0x4,%esp
  8015f8:	68 a0 1a 80 00       	push   $0x801aa0
  8015fd:	6a 07                	push   $0x7
  8015ff:	68 ab 1a 80 00       	push   $0x801aab
  801604:	e8 17 ea ff ff       	call   800020 <__panic>
