...
main(void) {
  ...
  8015fb:	50                   	push   %eax
  8015fc:	68 c0 1a 80 00       	push   $0x801ac0
  801601:	e8 cf ef ff ff       	call   8005d5 <cprintf>
  801606:	83 c4 10             	add    $0x10,%esp
    print_pgdir();
  801609:	e8 1c f3 ff ff       	call   80092a <print_pgdir>
    cprintf("pgdir pass.\n");
  80160e:	83 ec 0c             	sub    $0xc,%esp
  801611:	68 d7 1a 80 00       	push   $0x801ad7
  801616:	e8 ba ef ff ff       	call   8005d5 <cprintf>
  ...
  801626:	c9                   	leave  
  801627:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80162a:	c3                   	ret    
