...
main(void) {
  ...
  8015f3:	66 b8 28 00          	mov    $0x28,%ax
  8015f7:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8015f9:	83 ec 04             	sub    $0x4,%esp
  8015fc:	68 a0 1a 80 00       	push   $0x801aa0
  801601:	6a 09                	push   $0x9
  801603:	68 ab 1a 80 00       	push   $0x801aab
  801608:	e8 13 ea ff ff       	call   800020 <__panic>
