...
obj/__user_ls.out：     文件格式 elf32-i386
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 80 19 80 00       	push   $0x801980
  ...
  800057:	68 9a 19 80 00       	push   $0x80199a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 9c 19 80 00       	push   $0x80199c
  ...
  8000a5:	68 9a 19 80 00       	push   $0x80199a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 b8 19 80 00       	push   $0x8019b8
  ...
  80052a:	50                   	push   %eax
  80052b:	68 c3 19 80 00       	push   $0x8019c3
  ...
  800541:	50                   	push   %eax
  800542:	68 d5 19 80 00       	push   $0x8019d5
  ...
  800558:	50                   	push   %eax
  800559:	68 e8 19 80 00       	push   $0x8019e8
  ...
  80056f:	50                   	push   %eax
  800570:	68 fb 19 80 00       	push   $0x8019fb
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 0e 1a 80 00       	push   $0x801a0e
  ...
  800759:	68 15 1a 80 00       	push   $0x801a15
  80075e:	6a 1a                	push   $0x1a
  800760:	68 2f 1a 80 00       	push   $0x801a2f
  ...
  800772:	68 41 1a 80 00       	push   $0x801a41
  ...
  80078d:	68 49 1a 80 00       	push   $0x801a49
  800792:	6a 1d                	push   $0x1d
  800794:	68 2f 1a 80 00       	push   $0x801a2f
  ...
  8007aa:	e8 57 11 00 00       	call   801906 <main>
...
lock_fork(void) {
  ...
  800873:	68 40 20 80 00       	push   $0x802040
...
unlock_fork(void) {
  ...
  800884:	89 e5                	mov    %esp,%ebp
    unlock(&fork_lock);
  800886:	68 40 20 80 00       	push   $0x802040
...
exit(int error_code) {
  ...
  8008ad:	68 64 1a 80 00       	push   $0x801a64
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 84 1c 80 00       	add    $0x801c84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 a8 1c 80 00 	mov    0x801ca8(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 9e 1c 80 00       	push   $0x801c9e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be a1 1c 80 00       	mov    $0x801ca1,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8015e5:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8015e8:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8015ec:	8b 45 08             	mov    0x8(%ebp),%eax
  8015ef:	25 00 70 00 00       	and    $0x7000,%eax
  8015f4:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8015f9:	75 04                	jne    8015ff <getmode+0x1d>
  8015fb:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  8015ff:	8b 45 08             	mov    0x8(%ebp),%eax
  801602:	25 00 70 00 00       	and    $0x7000,%eax
  801607:	3d 00 20 00 00       	cmp    $0x2000,%eax
  80160c:	75 04                	jne    801612 <getmode+0x30>
  80160e:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  801612:	8b 45 08             	mov    0x8(%ebp),%eax
  801615:	25 00 70 00 00       	and    $0x7000,%eax
  80161a:	3d 00 30 00 00       	cmp    $0x3000,%eax
  80161f:	75 04                	jne    801625 <getmode+0x43>
  801621:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  801625:	8b 45 08             	mov    0x8(%ebp),%eax
  801628:	25 00 70 00 00       	and    $0x7000,%eax
  80162d:	3d 00 40 00 00       	cmp    $0x4000,%eax
  801632:	75 04                	jne    801638 <getmode+0x56>
  801634:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801638:	8b 45 08             	mov    0x8(%ebp),%eax
  80163b:	25 00 70 00 00       	and    $0x7000,%eax
  801640:	3d 00 50 00 00       	cmp    $0x5000,%eax
  801645:	75 04                	jne    80164b <getmode+0x69>
  801647:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  80164b:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  80164f:	c9                   	leave  
  801650:	c3                   	ret    
...
lsstat(struct stat *stat, const char *filename) {
  ...
  8016a7:	50                   	push   %eax
  8016a8:	e8 35 ff ff ff       	call   8015e2 <getmode>
  8016ad:	83 c4 04             	add    $0x4,%esp
  8016b0:	0f be c0             	movsbl %al,%eax
  8016b3:	83 ec 04             	sub    $0x4,%esp
  8016b6:	50                   	push   %eax
  8016b7:	68 00 1e 80 00       	push   $0x801e00
  8016bc:	6a 01                	push   $0x1
  8016be:	e8 e5 ef ff ff       	call   8006a8 <fprintf>
  ...
  8016cf:	50                   	push   %eax
  8016d0:	68 08 1e 80 00       	push   $0x801e08
  8016d5:	6a 01                	push   $0x1
  8016d7:	e8 cc ef ff ff       	call   8006a8 <fprintf>
  ...
  8016e8:	50                   	push   %eax
  8016e9:	68 10 1e 80 00       	push   $0x801e10
  8016ee:	6a 01                	push   $0x1
  8016f0:	e8 b3 ef ff ff       	call   8006a8 <fprintf>
  ...
  801701:	50                   	push   %eax
  801702:	68 18 1e 80 00       	push   $0x801e18
  801707:	6a 01                	push   $0x1
  801709:	e8 9a ef ff ff       	call   8006a8 <fprintf>
  80170e:	83 c4 10             	add    $0x10,%esp
    printf("   %s\n", filename);
  801711:	83 ec 04             	sub    $0x4,%esp
  801714:	ff 75 0c             	pushl  0xc(%ebp)
  801717:	68 20 1e 80 00       	push   $0x801e20
  80171c:	6a 01                	push   $0x1
  80171e:	e8 85 ef ff ff       	call   8006a8 <fprintf>
...
lsdir(const char *path) {
  ...
  80172c:	83 ec 28             	sub    $0x28,%esp
    struct stat __stat, *stat = &__stat;
  80172f:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801732:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  801735:	83 ec 0c             	sub    $0xc,%esp
  801738:	68 27 1e 80 00       	push   $0x801e27
  80173d:	e8 7a eb ff ff       	call   8002bc <opendir>
  801742:	83 c4 10             	add    $0x10,%esp
  801745:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  801748:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80174c:	75 3d                	jne    80178b <lsdir+0x62>
        return -1;
  80174e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801753:	e9 83 00 00 00       	jmp    8017db <lsdir+0xb2>
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
        if ((ret = getstat(direntp->name, stat)) != 0) {
  801758:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80175b:	83 c0 04             	add    $0x4,%eax
  80175e:	83 ec 08             	sub    $0x8,%esp
  801761:	ff 75 f4             	pushl  -0xc(%ebp)
  801764:	50                   	push   %eax
  801765:	e8 e7 fe ff ff       	call   801651 <getstat>
  80176a:	83 c4 10             	add    $0x10,%esp
  80176d:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801770:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801774:	75 53                	jne    8017c9 <lsdir+0xa0>
            goto failed;
        }
  ...
  801783:	e8 14 ff ff ff       	call   80169c <lsstat>
  ...
  801791:	e8 9a eb ff ff       	call   800330 <readdir>
  801796:	83 c4 10             	add    $0x10,%esp
  801799:	89 45 ec             	mov    %eax,-0x14(%ebp)
  80179c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8017a0:	75 b6                	jne    801758 <lsdir+0x2f>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
  ...
  8017a5:	68 29 1e 80 00       	push   $0x801e29
  8017aa:	6a 01                	push   $0x1
  8017ac:	e8 f7 ee ff ff       	call   8006a8 <fprintf>
  8017b1:	83 c4 10             	add    $0x10,%esp
    closedir(dirp);
  8017b4:	83 ec 0c             	sub    $0xc,%esp
  8017b7:	ff 75 f0             	pushl  -0x10(%ebp)
  8017ba:	e8 a2 eb ff ff       	call   800361 <closedir>
  8017bf:	83 c4 10             	add    $0x10,%esp
    return 0;
  8017c2:	b8 00 00 00 00       	mov    $0x0,%eax
  8017c7:	eb 12                	jmp    8017db <lsdir+0xb2>
        return -1;
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
...
failed:
  ...
  8017d0:	e8 8c eb ff ff       	call   800361 <closedir>
...
ls(const char *path) {
  ...
  8017e0:	83 ec 28             	sub    $0x28,%esp
    struct stat __stat, *stat = &__stat;
  8017e3:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  801813:	50                   	push   %eax
  801814:	e8 c9 fd ff ff       	call   8015e2 <getmode>
  801819:	83 c4 10             	add    $0x10,%esp
  80181c:	0f be c0             	movsbl %al,%eax
  80181f:	83 f8 63             	cmp    $0x63,%eax
  801822:	74 38                	je     80185c <ls+0x7f>
  801824:	83 f8 63             	cmp    $0x63,%eax
  801827:	7f 0c                	jg     801835 <ls+0x58>
  801829:	83 f8 30             	cmp    $0x30,%eax
  80182c:	74 13                	je     801841 <ls+0x64>
  80182e:	83 f8 62             	cmp    $0x62,%eax
  801831:	74 32                	je     801865 <ls+0x88>
  801833:	eb 39                	jmp    80186e <ls+0x91>
  801835:	83 f8 64             	cmp    $0x64,%eax
  801838:	74 10                	je     80184a <ls+0x6d>
  80183a:	83 f8 6c             	cmp    $0x6c,%eax
  80183d:	74 14                	je     801853 <ls+0x76>
  80183f:	eb 2d                	jmp    80186e <ls+0x91>
    case '0': type = 0; break;
  801841:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801848:	eb 2c                	jmp    801876 <ls+0x99>
    case 'd': type = 1; break;
  80184a:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801851:	eb 23                	jmp    801876 <ls+0x99>
    case 'l': type = 2; break;
  801853:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  80185a:	eb 1a                	jmp    801876 <ls+0x99>
    case 'c': type = 3; break;
  80185c:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801863:	eb 11                	jmp    801876 <ls+0x99>
    case 'b': type = 4; break;
  801865:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  80186c:	eb 08                	jmp    801876 <ls+0x99>
    default:  type = 5; break;
  80186e:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801875:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801876:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801879:	8b 04 85 10 20 80 00 	mov    0x802010(,%eax,4),%eax
  801880:	83 ec 04             	sub    $0x4,%esp
  801883:	50                   	push   %eax
  801884:	68 38 1e 80 00       	push   $0x801e38
  801889:	6a 01                	push   $0x1
  80188b:	e8 18 ee ff ff       	call   8006a8 <fprintf>
  ...
  80189c:	50                   	push   %eax
  80189d:	68 41 1e 80 00       	push   $0x801e41
  8018a2:	6a 01                	push   $0x1
  8018a4:	e8 ff ed ff ff       	call   8006a8 <fprintf>
  ...
  8018b5:	50                   	push   %eax
  8018b6:	68 4d 1e 80 00       	push   $0x801e4d
  8018bb:	6a 01                	push   $0x1
  8018bd:	e8 e6 ed ff ff       	call   8006a8 <fprintf>
  ...
  8018ce:	50                   	push   %eax
  8018cf:	68 59 1e 80 00       	push   $0x801e59
  8018d4:	6a 01                	push   $0x1
  8018d6:	e8 cd ed ff ff       	call   8006a8 <fprintf>
  8018db:	83 c4 10             	add    $0x10,%esp
    if (S_ISDIR(stat->st_mode)) {
  8018de:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8018e1:	8b 00                	mov    (%eax),%eax
  8018e3:	25 00 70 00 00       	and    $0x7000,%eax
  8018e8:	3d 00 20 00 00       	cmp    $0x2000,%eax
  8018ed:	75 10                	jne    8018ff <ls+0x122>
        return lsdir(path);
  8018ef:	83 ec 0c             	sub    $0xc,%esp
  8018f2:	ff 75 08             	pushl  0x8(%ebp)
  8018f5:	e8 2f fe ff ff       	call   801729 <lsdir>
  8018fa:	83 c4 10             	add    $0x10,%esp
  8018fd:	eb 05                	jmp    801904 <ls+0x127>
    }
    return 0;
...
main(int argc, char **argv) {
  801906:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80190a:	83 e4 f0             	and    $0xfffffff0,%esp
  80190d:	ff 71 fc             	pushl  -0x4(%ecx)
  801910:	55                   	push   %ebp
  801911:	89 e5                	mov    %esp,%ebp
  801913:	53                   	push   %ebx
  801914:	51                   	push   %ecx
  801915:	83 ec 10             	sub    $0x10,%esp
  801918:	89 cb                	mov    %ecx,%ebx
    if (argc == 1) {
  80191a:	83 3b 01             	cmpl   $0x1,(%ebx)
  80191d:	75 12                	jne    801931 <main+0x2b>
        return ls(".");
  80191f:	83 ec 0c             	sub    $0xc,%esp
  801922:	68 27 1e 80 00       	push   $0x801e27
  801927:	e8 b1 fe ff ff       	call   8017dd <ls>
  80192c:	83 c4 10             	add    $0x10,%esp
  80192f:	eb 44                	jmp    801975 <main+0x6f>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801931:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801938:	eb 2f                	jmp    801969 <main+0x63>
            if ((ret = ls(argv[i])) != 0) {
  ...
  801963:	eb 10                	jmp    801975 <main+0x6f>
    if (argc == 1) {
        ...
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801965:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801969:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80196c:	3b 03                	cmp    (%ebx),%eax
  80196e:	7c ca                	jl     80193a <main+0x34>
            if ((ret = ls(argv[i])) != 0) {
                return ret;
            }
        }
  ...
  801979:	5b                   	pop    %ebx
  80197a:	5d                   	pop    %ebp
  80197b:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80197e:	c3                   	ret    
