...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 20 16 80 00       	push   $0x801620
  ...
  800057:	68 3a 16 80 00       	push   $0x80163a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 3c 16 80 00       	push   $0x80163c
  ...
  8000a5:	68 3a 16 80 00       	push   $0x80163a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 58 16 80 00       	push   $0x801658
  ...
  80052a:	50                   	push   %eax
  80052b:	68 63 16 80 00       	push   $0x801663
  ...
  800541:	50                   	push   %eax
  800542:	68 75 16 80 00       	push   $0x801675
  ...
  800558:	50                   	push   %eax
  800559:	68 88 16 80 00       	push   $0x801688
  ...
  80056f:	50                   	push   %eax
  800570:	68 9b 16 80 00       	push   $0x80169b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 ae 16 80 00       	push   $0x8016ae
  ...
  800759:	68 b5 16 80 00       	push   $0x8016b5
  80075e:	6a 1a                	push   $0x1a
  800760:	68 cf 16 80 00       	push   $0x8016cf
  ...
  800772:	68 e1 16 80 00       	push   $0x8016e1
  ...
  80078d:	68 e9 16 80 00       	push   $0x8016e9
  800792:	6a 1d                	push   $0x1d
  800794:	68 cf 16 80 00       	push   $0x8016cf
...
exit(int error_code) {
  ...
  8008ad:	68 04 17 80 00       	push   $0x801704
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 24 19 80 00       	add    $0x801924,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 48 19 80 00 	mov    0x801948(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 3e 19 80 00       	push   $0x80193e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be 41 19 80 00       	mov    $0x801941,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015f3:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8015f8:	8b 00                	mov    (%eax),%eax
  8015fa:	83 ec 08             	sub    $0x8,%esp
  8015fd:	50                   	push   %eax
  8015fe:	68 a0 1a 80 00       	push   $0x801aa0
  801603:	e8 cd ef ff ff       	call   8005d5 <cprintf>
  801608:	83 c4 10             	add    $0x10,%esp
    panic("FAIL: T.T\n");
  80160b:	83 ec 04             	sub    $0x4,%esp
  80160e:	68 be 1a 80 00       	push   $0x801abe
  801613:	6a 07                	push   $0x7
  801615:	68 c9 1a 80 00       	push   $0x801ac9
  80161a:	e8 01 ea ff ff       	call   800020 <__panic>
