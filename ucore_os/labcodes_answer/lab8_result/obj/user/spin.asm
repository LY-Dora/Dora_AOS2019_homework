...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 20 17 80 00       	push   $0x801720
  ...
  800057:	68 3a 17 80 00       	push   $0x80173a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 3c 17 80 00       	push   $0x80173c
  ...
  8000a5:	68 3a 17 80 00       	push   $0x80173a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 58 17 80 00       	push   $0x801758
  ...
  80052a:	50                   	push   %eax
  80052b:	68 63 17 80 00       	push   $0x801763
  ...
  800541:	50                   	push   %eax
  800542:	68 75 17 80 00       	push   $0x801775
  ...
  800558:	50                   	push   %eax
  800559:	68 88 17 80 00       	push   $0x801788
  ...
  80056f:	50                   	push   %eax
  800570:	68 9b 17 80 00       	push   $0x80179b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 ae 17 80 00       	push   $0x8017ae
  ...
  800759:	68 b5 17 80 00       	push   $0x8017b5
  80075e:	6a 1a                	push   $0x1a
  800760:	68 cf 17 80 00       	push   $0x8017cf
  ...
  800772:	68 e1 17 80 00       	push   $0x8017e1
  ...
  80078d:	68 e9 17 80 00       	push   $0x8017e9
  800792:	6a 1d                	push   $0x1d
  800794:	68 cf 17 80 00       	push   $0x8017cf
...
exit(int error_code) {
  ...
  8008ad:	68 04 18 80 00       	push   $0x801804
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 24 1a 80 00       	add    $0x801a24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 48 1a 80 00 	mov    0x801a48(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 3e 1a 80 00       	push   $0x801a3e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be 41 1a 80 00       	mov    $0x801a41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015f6:	68 a0 1b 80 00       	push   $0x801ba0
  ...
  80160f:	75 12                	jne    801623 <main+0x41>
        cprintf("I am the child. spinning ...\n");
  801611:	83 ec 0c             	sub    $0xc,%esp
  801614:	68 c7 1b 80 00       	push   $0x801bc7
  801619:	e8 b7 ef ff ff       	call   8005d5 <cprintf>
  80161e:	83 c4 10             	add    $0x10,%esp
        while (1);
  801621:	eb fe                	jmp    801621 <main+0x3f>
    }else if (pid<0) {
  801623:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801627:	79 14                	jns    80163d <main+0x5b>
        panic("fork child error\n");
  801629:	83 ec 04             	sub    $0x4,%esp
  80162c:	68 e5 1b 80 00       	push   $0x801be5
  801631:	6a 0d                	push   $0xd
  801633:	68 f7 1b 80 00       	push   $0x801bf7
  801638:	e8 e3 e9 ff ff       	call   800020 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  80163d:	83 ec 0c             	sub    $0xc,%esp
  801640:	68 04 1c 80 00       	push   $0x801c04
  801645:	e8 8b ef ff ff       	call   8005d5 <cprintf>
  80164a:	83 c4 10             	add    $0x10,%esp

    yield();
  80164d:	e8 a7 f2 ff ff       	call   8008f9 <yield>
    yield();
  801652:	e8 a2 f2 ff ff       	call   8008f9 <yield>
    yield();
  801657:	e8 9d f2 ff ff       	call   8008f9 <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  80165c:	83 ec 0c             	sub    $0xc,%esp
  80165f:	68 2c 1c 80 00       	push   $0x801c2c
  801664:	e8 6c ef ff ff       	call   8005d5 <cprintf>
  801669:	83 c4 10             	add    $0x10,%esp

    assert((ret = kill(pid)) == 0);
  80166c:	83 ec 0c             	sub    $0xc,%esp
  80166f:	ff 75 f4             	pushl  -0xc(%ebp)
  801672:	e8 90 f2 ff ff       	call   800907 <kill>
  801677:	83 c4 10             	add    $0x10,%esp
  80167a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80167d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801681:	74 16                	je     801699 <main+0xb7>
  801683:	68 54 1c 80 00       	push   $0x801c54
  801688:	68 6b 1c 80 00       	push   $0x801c6b
  80168d:	6a 17                	push   $0x17
  80168f:	68 f7 1b 80 00       	push   $0x801bf7
  801694:	e8 87 e9 ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  801699:	83 ec 08             	sub    $0x8,%esp
  80169c:	ff 75 f0             	pushl  -0x10(%ebp)
  80169f:	68 80 1c 80 00       	push   $0x801c80
  8016a4:	e8 2c ef ff ff       	call   8005d5 <cprintf>
  ...
  8016b4:	e8 27 f2 ff ff       	call   8008e0 <waitpid>
  8016b9:	83 c4 10             	add    $0x10,%esp
  8016bc:	89 45 f0             	mov    %eax,-0x10(%ebp)
  8016bf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  8016c3:	74 16                	je     8016db <main+0xf9>
  8016c5:	68 94 1c 80 00       	push   $0x801c94
  8016ca:	68 6b 1c 80 00       	push   $0x801c6b
  8016cf:	6a 1a                	push   $0x1a
  8016d1:	68 f7 1b 80 00       	push   $0x801bf7
  8016d6:	e8 45 e9 ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  8016db:	83 ec 08             	sub    $0x8,%esp
  8016de:	ff 75 f0             	pushl  -0x10(%ebp)
  8016e1:	68 b4 1c 80 00       	push   $0x801cb4
  8016e6:	e8 ea ee ff ff       	call   8005d5 <cprintf>
  8016eb:	83 c4 10             	add    $0x10,%esp

    cprintf("spin may pass.\n");
  8016ee:	83 ec 0c             	sub    $0xc,%esp
  8016f1:	68 c5 1c 80 00       	push   $0x801cc5
  8016f6:	e8 da ee ff ff       	call   8005d5 <cprintf>
  8016fb:	83 c4 10             	add    $0x10,%esp
    return 0;
  8016fe:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801703:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801706:	c9                   	leave  
  801707:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80170a:	c3                   	ret    
