...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 e0 19 80 00       	push   $0x8019e0
  ...
  800057:	68 fa 19 80 00       	push   $0x8019fa
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 fc 19 80 00       	push   $0x8019fc
  ...
  8000a5:	68 fa 19 80 00       	push   $0x8019fa
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 18 1a 80 00       	push   $0x801a18
  ...
  80052a:	50                   	push   %eax
  80052b:	68 23 1a 80 00       	push   $0x801a23
  ...
  800541:	50                   	push   %eax
  800542:	68 35 1a 80 00       	push   $0x801a35
  ...
  800558:	50                   	push   %eax
  800559:	68 48 1a 80 00       	push   $0x801a48
  ...
  80056f:	50                   	push   %eax
  800570:	68 5b 1a 80 00       	push   $0x801a5b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 6e 1a 80 00       	push   $0x801a6e
  ...
  800759:	68 75 1a 80 00       	push   $0x801a75
  80075e:	6a 1a                	push   $0x1a
  800760:	68 8f 1a 80 00       	push   $0x801a8f
  ...
  800772:	68 a1 1a 80 00       	push   $0x801aa1
  ...
  80078d:	68 a9 1a 80 00       	push   $0x801aa9
  800792:	6a 1d                	push   $0x1d
  800794:	68 8f 1a 80 00       	push   $0x801a8f
  ...
  8007aa:	e8 67 10 00 00       	call   801816 <main>
...
exit(int error_code) {
  ...
  8008ad:	68 c4 1a 80 00       	push   $0x801ac4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 e4 1c 80 00       	add    $0x801ce4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 08 1d 80 00 	mov    0x801d08(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 fe 1c 80 00       	push   $0x801cfe
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be 01 1d 80 00       	mov    $0x801d01,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8015e9:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8015f0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8015f7:	eb 65                	jmp    80165e <work+0x7c>
        for (j = 0; j < size; j ++) {
  8015f9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801600:	eb 50                	jmp    801652 <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  801613:	c7 04 85 e0 21 80 00 	movl   $0x1,0x8021e0(,%eax,4)
  80161a:	01 00 00 00 
  ...
  80162f:	8b 0c 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%ecx
  ...
  801647:	89 0c 85 40 20 80 00 	mov    %ecx,0x802040(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  80164e:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801652:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801655:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801658:	7c a8                	jl     801602 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
  ...
  801661:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801664:	7c 93                	jl     8015f9 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801666:	e8 8e f2 ff ff       	call   8008f9 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  80166b:	e8 ad f2 ff ff       	call   80091d <getpid>
  801670:	83 ec 04             	sub    $0x4,%esp
  801673:	ff 75 08             	pushl  0x8(%ebp)
  801676:	50                   	push   %eax
  801677:	68 60 1e 80 00       	push   $0x801e60
  80167c:	e8 54 ef ff ff       	call   8005d5 <cprintf>
  801681:	83 c4 10             	add    $0x10,%esp

    while (times -- > 0) {
  801684:	e9 5c 01 00 00       	jmp    8017e5 <work+0x203>
        for (i = 0; i < size; i ++) {
  801689:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801690:	e9 b6 00 00 00       	jmp    80174b <work+0x169>
            for (j = 0; j < size; j ++) {
  801695:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80169c:	e9 9a 00 00 00       	jmp    80173b <work+0x159>
                matc[i][j] = 0;
  ...
  8016ad:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8016b0:	01 d0                	add    %edx,%eax
  8016b2:	c7 04 85 80 23 80 00 	movl   $0x0,0x802380(,%eax,4)
  8016b9:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8016bd:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8016c4:	eb 69                	jmp    80172f <work+0x14d>
                    matc[i][j] += mata[i][k] * matb[k][j];
  8016c6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8016c9:	89 d0                	mov    %edx,%eax
  8016cb:	c1 e0 02             	shl    $0x2,%eax
  8016ce:	01 d0                	add    %edx,%eax
  8016d0:	01 c0                	add    %eax,%eax
  8016d2:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8016d5:	01 d0                	add    %edx,%eax
  8016d7:	8b 0c 85 80 23 80 00 	mov    0x802380(,%eax,4),%ecx
  ...
  8016ef:	8b 1c 85 40 20 80 00 	mov    0x802040(,%eax,4),%ebx
  ...
  801707:	8b 04 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%eax
  80170e:	0f af c3             	imul   %ebx,%eax
  801711:	01 c1                	add    %eax,%ecx
  ...
  801724:	89 0c 85 80 23 80 00 	mov    %ecx,0x802380(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  80172b:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  80172f:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801732:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801735:	7c 8f                	jl     8016c6 <work+0xe4>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801737:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80173b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80173e:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801741:	0f 8c 5a ff ff ff    	jl     8016a1 <work+0xbf>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801747:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80174b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80174e:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801751:	0f 8c 3e ff ff ff    	jl     801695 <work+0xb3>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  80175e:	eb 79                	jmp    8017d9 <work+0x1f7>
            for (j = 0; j < size; j ++) {
  801760:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801767:	eb 64                	jmp    8017cd <work+0x1eb>
  ...
  80177a:	8b 0c 85 80 23 80 00 	mov    0x802380(,%eax,4),%ecx
  ...
  8017c2:	89 0c 85 40 20 80 00 	mov    %ecx,0x802040(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8017c9:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8017cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017d0:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8017d3:	7c 94                	jl     801769 <work+0x187>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8017d5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8017d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017dc:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8017df:	0f 8c 7b ff ff ff    	jl     801760 <work+0x17e>
  ...
  8017e8:	8d 50 ff             	lea    -0x1(%eax),%edx
  8017eb:	89 55 08             	mov    %edx,0x8(%ebp)
  8017ee:	85 c0                	test   %eax,%eax
  8017f0:	0f 85 93 fe ff ff    	jne    801689 <work+0xa7>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8017f6:	e8 22 f1 ff ff       	call   80091d <getpid>
  8017fb:	83 ec 08             	sub    $0x8,%esp
  8017fe:	50                   	push   %eax
  8017ff:	68 80 1e 80 00       	push   $0x801e80
  801804:	e8 cc ed ff ff       	call   8005d5 <cprintf>
  801809:	83 c4 10             	add    $0x10,%esp
    exit(0);
  80180c:	83 ec 0c             	sub    $0xc,%esp
  80180f:	6a 00                	push   $0x0
  801811:	e8 80 f0 ff ff       	call   800896 <exit>
...
int
main(void) {
  801816:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80181a:	83 e4 f0             	and    $0xfffffff0,%esp
  80181d:	ff 71 fc             	pushl  -0x4(%ecx)
  801820:	55                   	push   %ebp
  801821:	89 e5                	mov    %esp,%ebp
  801823:	53                   	push   %ebx
  801824:	51                   	push   %ecx
  801825:	83 ec 10             	sub    $0x10,%esp
  801828:	89 e0                	mov    %esp,%eax
  80182a:	89 c3                	mov    %eax,%ebx
    int pids[total];
  80182c:	b8 15 00 00 00       	mov    $0x15,%eax
  801831:	83 e8 01             	sub    $0x1,%eax
  801834:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801837:	b8 15 00 00 00       	mov    $0x15,%eax
  80183c:	c1 e0 02             	shl    $0x2,%eax
  80183f:	8d 50 03             	lea    0x3(%eax),%edx
  801842:	b8 10 00 00 00       	mov    $0x10,%eax
  801847:	83 e8 01             	sub    $0x1,%eax
  80184a:	01 d0                	add    %edx,%eax
  80184c:	b9 10 00 00 00       	mov    $0x10,%ecx
  801851:	ba 00 00 00 00       	mov    $0x0,%edx
  801856:	f7 f1                	div    %ecx
  801858:	6b c0 10             	imul   $0x10,%eax,%eax
  80185b:	29 c4                	sub    %eax,%esp
  80185d:	89 e0                	mov    %esp,%eax
  80185f:	83 c0 03             	add    $0x3,%eax
  801862:	c1 e8 02             	shr    $0x2,%eax
  801865:	c1 e0 02             	shl    $0x2,%eax
  801868:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  80186b:	b8 15 00 00 00       	mov    $0x15,%eax
  801870:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801877:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80187a:	83 ec 04             	sub    $0x4,%esp
  80187d:	52                   	push   %edx
  80187e:	6a 00                	push   $0x0
  801880:	50                   	push   %eax
  801881:	e8 84 f4 ff ff       	call   800d0a <memset>
  801886:	83 c4 10             	add    $0x10,%esp

    int i;
    for (i = 0; i < total; i ++) {
  801889:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801890:	eb 78                	jmp    80190a <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801892:	e8 25 f0 ff ff       	call   8008bc <fork>
  801897:	89 c1                	mov    %eax,%ecx
  801899:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80189c:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80189f:	89 0c 90             	mov    %ecx,(%eax,%edx,4)
  8018a2:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8018a5:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8018a8:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8018ab:	85 c0                	test   %eax,%eax
  8018ad:	75 4a                	jne    8018f9 <main+0xe3>
            srand(i * i);
  8018af:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8018b2:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  8018b6:	83 ec 0c             	sub    $0xc,%esp
  8018b9:	50                   	push   %eax
  8018ba:	e8 0a fd ff ff       	call   8015c9 <srand>
  8018bf:	83 c4 10             	add    $0x10,%esp
            int times = (((unsigned int)rand()) % total);
  8018c2:	e8 43 fc ff ff       	call   80150a <rand>
  8018c7:	ba 15 00 00 00       	mov    $0x15,%edx
  8018cc:	89 d1                	mov    %edx,%ecx
  8018ce:	ba 00 00 00 00       	mov    $0x0,%edx
  8018d3:	f7 f1                	div    %ecx
  8018d5:	89 d0                	mov    %edx,%eax
  8018d7:	89 45 e8             	mov    %eax,-0x18(%ebp)
            times = (times * times + 10) * 100;
  8018da:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018dd:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  8018e1:	83 c0 0a             	add    $0xa,%eax
  8018e4:	6b c0 64             	imul   $0x64,%eax,%eax
  8018e7:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  8018ea:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018ed:	83 ec 0c             	sub    $0xc,%esp
  8018f0:	50                   	push   %eax
  8018f1:	e8 ec fc ff ff       	call   8015e2 <work>
  8018f6:	83 c4 10             	add    $0x10,%esp
        }
        if (pids[i] < 0) {
  8018f9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8018fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8018ff:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801902:	85 c0                	test   %eax,%eax
  801904:	78 6d                	js     801973 <main+0x15d>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801906:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80190a:	b8 15 00 00 00       	mov    $0x15,%eax
  80190f:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801912:	0f 8c 7a ff ff ff    	jl     801892 <main+0x7c>
        if (pids[i] < 0) {
            goto failed;
        }
    }
  ...
  80191b:	68 94 1e 80 00       	push   $0x801e94
  801920:	e8 b0 ec ff ff       	call   8005d5 <cprintf>
  801925:	83 c4 10             	add    $0x10,%esp

    for (i = 0; i < total; i ++) {
  801928:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80192f:	eb 1f                	jmp    801950 <main+0x13a>
        if (wait() != 0) {
  801931:	e8 93 ef ff ff       	call   8008c9 <wait>
  801936:	85 c0                	test   %eax,%eax
  801938:	74 12                	je     80194c <main+0x136>
            cprintf("wait failed.\n");
  80193a:	83 ec 0c             	sub    $0xc,%esp
  80193d:	68 9e 1e 80 00       	push   $0x801e9e
  801942:	e8 8e ec ff ff       	call   8005d5 <cprintf>
  801947:	83 c4 10             	add    $0x10,%esp
            goto failed;
  80194a:	eb 28                	jmp    801974 <main+0x15e>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  80194c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801950:	b8 15 00 00 00       	mov    $0x15,%eax
  801955:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801958:	7c d7                	jl     801931 <main+0x11b>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
  ...
  80195d:	68 ac 1e 80 00       	push   $0x801eac
  801962:	e8 6e ec ff ff       	call   8005d5 <cprintf>
  801967:	83 c4 10             	add    $0x10,%esp
    return 0;
  80196a:	b8 00 00 00 00       	mov    $0x0,%eax
  80196f:	89 dc                	mov    %ebx,%esp
  801971:	eb 4e                	jmp    8019c1 <main+0x1ab>
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
        }
...
failed:
    for (i = 0; i < total; i ++) {
  80199f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8019a3:	b8 15 00 00 00       	mov    $0x15,%eax
  8019a8:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8019ab:	7c d0                	jl     80197d <main+0x167>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
  ...
  8019b0:	68 ba 1e 80 00       	push   $0x801eba
  8019b5:	6a 52                	push   $0x52
  8019b7:	68 c5 1e 80 00       	push   $0x801ec5
  8019bc:	e8 5f e6 ff ff       	call   800020 <__panic>
}
  8019c1:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8019c4:	59                   	pop    %ecx
  8019c5:	5b                   	pop    %ebx
  8019c6:	5d                   	pop    %ebp
  8019c7:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8019ca:	c3                   	ret    
