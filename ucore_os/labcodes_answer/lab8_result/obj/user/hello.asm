...
exit(int error_code) {
  ...
  8008ad:	68 24 17 80 00       	push   $0x801724
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 44 19 80 00       	add    $0x801944,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 68 19 80 00 	mov    0x801968(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 5e 19 80 00       	push   $0x80195e
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be 61 19 80 00       	mov    $0x801961,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015f6:	68 c0 1a 80 00       	push   $0x801ac0
  8015fb:	e8 d5 ef ff ff       	call   8005d5 <cprintf>
  801600:	83 c4 10             	add    $0x10,%esp
    cprintf("I am process %d.\n", getpid());
  801603:	e8 15 f3 ff ff       	call   80091d <getpid>
  801608:	83 ec 08             	sub    $0x8,%esp
  80160b:	50                   	push   %eax
  80160c:	68 d0 1a 80 00       	push   $0x801ad0
  801611:	e8 bf ef ff ff       	call   8005d5 <cprintf>
  801616:	83 c4 10             	add    $0x10,%esp
    cprintf("hello pass.\n");
  801619:	83 ec 0c             	sub    $0xc,%esp
  80161c:	68 e2 1a 80 00       	push   $0x801ae2
  801621:	e8 af ef ff ff       	call   8005d5 <cprintf>
  ...
  801631:	c9                   	leave  
  801632:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801635:	c3                   	ret    
