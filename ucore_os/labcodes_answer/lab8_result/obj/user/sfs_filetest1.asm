...
obj/__user_sfs_filetest1.out：     文件格式 elf32-i386
...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 02 0f 00 00       	call   8016b1 <main>
...
static int safe_open(const char *path, int open_flags)
{
  ...
  8015f2:	e8 b5 ed ff ff       	call   8003ac <open>
  8015f7:	83 c4 10             	add    $0x10,%esp
  8015fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
	printf("fd is %d\n",fd);
  8015fd:	83 ec 04             	sub    $0x4,%esp
  801600:	ff 75 f4             	pushl  -0xc(%ebp)
  801603:	68 a0 1b 80 00       	push   $0x801ba0
  801608:	6a 01                	push   $0x1
  80160a:	e8 99 f0 ff ff       	call   8006a8 <fprintf>
  80160f:	83 c4 10             	add    $0x10,%esp
	assert(fd >= 0);
  801612:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801616:	79 16                	jns    80162e <safe_open+0x4c>
  801618:	68 aa 1b 80 00       	push   $0x801baa
  80161d:	68 b2 1b 80 00       	push   $0x801bb2
  801622:	6a 10                	push   $0x10
  801624:	68 c7 1b 80 00       	push   $0x801bc7
  801629:	e8 f2 e9 ff ff       	call   800020 <__panic>
	return fd;
...
static struct stat *safe_fstat(int fd)
{
  ...
  801639:	a1 10 20 80 00       	mov    0x802010,%eax
  80163e:	83 ec 08             	sub    $0x8,%esp
  801641:	50                   	push   %eax
  801642:	ff 75 08             	pushl  0x8(%ebp)
  801645:	e8 e5 ed ff ff       	call   80042f <fstat>
  80164a:	83 c4 10             	add    $0x10,%esp
  80164d:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == 0);
  801650:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801654:	74 16                	je     80166c <safe_fstat+0x39>
  801656:	68 dc 1b 80 00       	push   $0x801bdc
  80165b:	68 b2 1b 80 00       	push   $0x801bb2
  801660:	6a 18                	push   $0x18
  801662:	68 c7 1b 80 00       	push   $0x801bc7
  801667:	e8 b4 e9 ff ff       	call   800020 <__panic>
	return stat;
  80166c:	a1 10 20 80 00       	mov    0x802010,%eax
}
  801671:	c9                   	leave  
  801672:	c3                   	ret    
...
static void safe_read(int fd, void *data, size_t len)
{
  ...
  801685:	e8 51 ed ff ff       	call   8003db <read>
  80168a:	83 c4 10             	add    $0x10,%esp
  80168d:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == len);
  801690:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801693:	3b 45 10             	cmp    0x10(%ebp),%eax
  801696:	74 16                	je     8016ae <safe_read+0x3b>
  801698:	68 e5 1b 80 00       	push   $0x801be5
  80169d:	68 b2 1b 80 00       	push   $0x801bb2
  8016a2:	6a 20                	push   $0x20
  8016a4:	68 c7 1b 80 00       	push   $0x801bc7
  8016a9:	e8 72 e9 ff ff       	call   800020 <__panic>
}
  8016ae:	90                   	nop
  8016af:	c9                   	leave  
  8016b0:	c3                   	ret    
...
int main(void)
{
  8016b1:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8016b5:	83 e4 f0             	and    $0xfffffff0,%esp
  8016b8:	ff 71 fc             	pushl  -0x4(%ecx)
  8016bb:	55                   	push   %ebp
  ...
  8016c7:	68 f0 1b 80 00       	push   $0x801bf0
  8016cc:	e8 11 ff ff ff       	call   8015e2 <safe_open>
  ...
  8016dd:	e8 51 ff ff ff       	call   801633 <safe_fstat>
  ...
  8016eb:	68 fe 1b 80 00       	push   $0x801bfe
  8016f0:	6a 01                	push   $0x1
  8016f2:	e8 b1 ef ff ff       	call   8006a8 <fprintf>
  ...
  801702:	c9                   	leave  
  801703:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801706:	c3                   	ret    
