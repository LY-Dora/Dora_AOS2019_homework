...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 c0 18 80 00       	push   $0x8018c0
  ...
  800057:	68 da 18 80 00       	push   $0x8018da
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 dc 18 80 00       	push   $0x8018dc
  ...
  8000a5:	68 da 18 80 00       	push   $0x8018da
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 f8 18 80 00       	push   $0x8018f8
  ...
  80052a:	50                   	push   %eax
  80052b:	68 03 19 80 00       	push   $0x801903
  ...
  800541:	50                   	push   %eax
  800542:	68 15 19 80 00       	push   $0x801915
  ...
  800558:	50                   	push   %eax
  800559:	68 28 19 80 00       	push   $0x801928
  ...
  80056f:	50                   	push   %eax
  800570:	68 3b 19 80 00       	push   $0x80193b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 4e 19 80 00       	push   $0x80194e
  ...
  800759:	68 55 19 80 00       	push   $0x801955
  80075e:	6a 1a                	push   $0x1a
  800760:	68 6f 19 80 00       	push   $0x80196f
  ...
  800772:	68 81 19 80 00       	push   $0x801981
  ...
  80078d:	68 89 19 80 00       	push   $0x801989
  800792:	6a 1d                	push   $0x1d
  800794:	68 6f 19 80 00       	push   $0x80196f
  ...
  8007aa:	e8 60 0e 00 00       	call   80160f <main>
...
exit(int error_code) {
  ...
  8008ad:	68 a4 19 80 00       	push   $0x8019a4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f6c:	05 c4 1b 80 00       	add    $0x801bc4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010bd:	8b 04 85 e8 1b 80 00 	mov    0x801be8(,%eax,4),%eax
  ...
  8011bf:	56                   	push   %esi
  8011c0:	68 de 1b 80 00       	push   $0x801bde
  ...
  8011e8:	75 05                	jne    8011ef <vprintfmt+0x1a3>
                p = "(null)";
  8011ea:	be e1 1b 80 00       	mov    $0x801be1,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8015ef:	eb 12                	jmp    801603 <spin_delay+0x21>
     {
          j = !j;
  8015f1:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8015f4:	85 c0                	test   %eax,%eax
  8015f6:	0f 94 c0             	sete   %al
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8015ff:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  801603:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  80160a:	75 e5                	jne    8015f1 <spin_delay+0xf>
     {
          j = !j;
     }
}
...
int
main(void) {
  80160f:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801613:	83 e4 f0             	and    $0xfffffff0,%esp
  801616:	ff 71 fc             	pushl  -0x4(%ecx)
  801619:	55                   	push   %ebp
  ...
  801624:	68 90 01 00 00       	push   $0x190
  801629:	68 40 1d 80 00       	push   $0x801d40
  80162e:	e8 a2 ef ff ff       	call   8005d5 <cprintf>
  801633:	83 c4 10             	add    $0x10,%esp
     sleep(SLEEP_TIME);
  801636:	83 ec 0c             	sub    $0xc,%esp
  801639:	68 90 01 00 00       	push   $0x190
  80163e:	e8 0c f3 ff ff       	call   80094f <sleep>
  801643:	83 c4 10             	add    $0x10,%esp
     memset(pids, 0, sizeof(pids));
  801646:	83 ec 04             	sub    $0x4,%esp
  801649:	6a 14                	push   $0x14
  80164b:	6a 00                	push   $0x0
  80164d:	68 70 21 80 00       	push   $0x802170
  801652:	e8 b3 f6 ff ff       	call   800d0a <memset>
  801657:	83 c4 10             	add    $0x10,%esp
     lab6_set_priority(TOTAL + 1);
  80165a:	83 ec 0c             	sub    $0xc,%esp
  80165d:	6a 06                	push   $0x6
  80165f:	e8 d4 f2 ff ff       	call   800938 <lab6_set_priority>
  801664:	83 c4 10             	add    $0x10,%esp

     for (i = 0; i < TOTAL; i ++) {
  801667:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80166e:	e9 ee 00 00 00       	jmp    801761 <main+0x152>
          acc[i]=0;
  801673:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801676:	c7 04 85 48 21 80 00 	movl   $0x0,0x802148(,%eax,4)
  80167d:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801681:	e8 36 f2 ff ff       	call   8008bc <fork>
  801686:	89 c2                	mov    %eax,%edx
  801688:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80168b:	89 14 85 70 21 80 00 	mov    %edx,0x802170(,%eax,4)
  801692:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801695:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  80169c:	85 c0                	test   %eax,%eax
  80169e:	0f 85 a7 00 00 00    	jne    80174b <main+0x13c>
               lab6_set_priority(i + 1);
  8016a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016a7:	83 c0 01             	add    $0x1,%eax
  8016aa:	83 ec 0c             	sub    $0xc,%esp
  8016ad:	50                   	push   %eax
  8016ae:	e8 85 f2 ff ff       	call   800938 <lab6_set_priority>
  8016b3:	83 c4 10             	add    $0x10,%esp
               acc[i] = 0;
  8016b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016b9:	c7 04 85 48 21 80 00 	movl   $0x0,0x802148(,%eax,4)
  8016c0:	00 00 00 00 
               while (1) {
                    spin_delay();
  8016c4:	e8 19 ff ff ff       	call   8015e2 <spin_delay>
                    ++ acc[i];
  8016c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016cc:	8b 04 85 48 21 80 00 	mov    0x802148(,%eax,4),%eax
  8016d3:	8d 50 01             	lea    0x1(%eax),%edx
  8016d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016d9:	89 14 85 48 21 80 00 	mov    %edx,0x802148(,%eax,4)
                    if(acc[i]%4000==0) {
  8016e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016e3:	8b 0c 85 48 21 80 00 	mov    0x802148(,%eax,4),%ecx
  8016ea:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8016ef:	89 c8                	mov    %ecx,%eax
  8016f1:	f7 e2                	mul    %edx
  8016f3:	89 d0                	mov    %edx,%eax
  8016f5:	c1 e8 08             	shr    $0x8,%eax
  8016f8:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8016fe:	29 c1                	sub    %eax,%ecx
  801700:	89 c8                	mov    %ecx,%eax
  801702:	85 c0                	test   %eax,%eax
  801704:	75 be                	jne    8016c4 <main+0xb5>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  801706:	e8 5a f2 ff ff       	call   800965 <gettime_msec>
  80170b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80170e:	81 7d f0 78 05 00 00 	cmpl   $0x578,-0x10(%ebp)
  801715:	7e ad                	jle    8016c4 <main+0xb5>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801717:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80171a:	8b 1c 85 48 21 80 00 	mov    0x802148(,%eax,4),%ebx
  801721:	e8 f7 f1 ff ff       	call   80091d <getpid>
  801726:	ff 75 f0             	pushl  -0x10(%ebp)
  801729:	53                   	push   %ebx
  80172a:	50                   	push   %eax
  80172b:	68 68 1d 80 00       	push   $0x801d68
  801730:	e8 a0 ee ff ff       	call   8005d5 <cprintf>
  801735:	83 c4 10             	add    $0x10,%esp
                            exit(acc[i]);
  801738:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80173b:	8b 04 85 48 21 80 00 	mov    0x802148(,%eax,4),%eax
  801742:	83 ec 0c             	sub    $0xc,%esp
  801745:	50                   	push   %eax
  801746:	e8 4b f1 ff ff       	call   800896 <exit>
                        }
                    }
               }
  ...
  80174e:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  801755:	85 c0                	test   %eax,%eax
  801757:	0f 88 09 01 00 00    	js     801866 <main+0x257>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80175d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801761:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  801765:	0f 8e 08 ff ff ff    	jle    801673 <main+0x64>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80176e:	68 88 1d 80 00       	push   $0x801d88
  801773:	e8 5d ee ff ff       	call   8005d5 <cprintf>
  801778:	83 c4 10             	add    $0x10,%esp

     for (i = 0; i < TOTAL; i ++) {
  80177b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801782:	eb 60                	jmp    8017e4 <main+0x1d5>
         status[i]=0;
  801784:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801787:	c7 04 85 5c 21 80 00 	movl   $0x0,0x80215c(,%eax,4)
  80178e:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  801792:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801795:	c1 e0 02             	shl    $0x2,%eax
  801798:	8d 90 5c 21 80 00    	lea    0x80215c(%eax),%edx
  80179e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017a1:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  8017a8:	83 ec 08             	sub    $0x8,%esp
  8017ab:	52                   	push   %edx
  8017ac:	50                   	push   %eax
  8017ad:	e8 2e f1 ff ff       	call   8008e0 <waitpid>
  8017b2:	83 c4 10             	add    $0x10,%esp
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8017b5:	e8 ab f1 ff ff       	call   800965 <gettime_msec>
  8017ba:	89 c1                	mov    %eax,%ecx
  8017bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017bf:	8b 14 85 5c 21 80 00 	mov    0x80215c(,%eax,4),%edx
  8017c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017c9:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  8017d0:	51                   	push   %ecx
  8017d1:	52                   	push   %edx
  8017d2:	50                   	push   %eax
  8017d3:	68 b0 1d 80 00       	push   $0x801db0
  8017d8:	e8 f8 ed ff ff       	call   8005d5 <cprintf>
  8017dd:	83 c4 10             	add    $0x10,%esp
     ...
     for (i = 0; i < TOTAL; i ++) {
  8017e0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8017e4:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  8017e8:	7e 9a                	jle    801784 <main+0x175>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
  ...
  8017ed:	68 cf 1d 80 00       	push   $0x801dcf
  8017f2:	e8 de ed ff ff       	call   8005d5 <cprintf>
  8017f7:	83 c4 10             	add    $0x10,%esp
     cprintf("stride sched correct result:");
  8017fa:	83 ec 0c             	sub    $0xc,%esp
  8017fd:	68 e5 1d 80 00       	push   $0x801de5
  801802:	e8 ce ed ff ff       	call   8005d5 <cprintf>
  801807:	83 c4 10             	add    $0x10,%esp
     for (i = 0; i < TOTAL; i ++)
  80180a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801811:	eb 36                	jmp    801849 <main+0x23a>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801813:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801816:	8b 04 85 5c 21 80 00 	mov    0x80215c(,%eax,4),%eax
  80181d:	01 c0                	add    %eax,%eax
  80181f:	8b 1d 5c 21 80 00    	mov    0x80215c,%ebx
  801825:	99                   	cltd   
  801826:	f7 fb                	idiv   %ebx
  801828:	83 c0 01             	add    $0x1,%eax
  80182b:	89 c2                	mov    %eax,%edx
  80182d:	c1 ea 1f             	shr    $0x1f,%edx
  801830:	01 d0                	add    %edx,%eax
  801832:	d1 f8                	sar    %eax
  801834:	83 ec 08             	sub    $0x8,%esp
  801837:	50                   	push   %eax
  801838:	68 02 1e 80 00       	push   $0x801e02
  80183d:	e8 93 ed ff ff       	call   8005d5 <cprintf>
  801842:	83 c4 10             	add    $0x10,%esp
     ...
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801845:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801849:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  80184d:	7e c4                	jle    801813 <main+0x204>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  80184f:	83 ec 0c             	sub    $0xc,%esp
  801852:	68 06 1e 80 00       	push   $0x801e06
  801857:	e8 79 ed ff ff       	call   8005d5 <cprintf>
  80185c:	83 c4 10             	add    $0x10,%esp

     return 0;
  80185f:	b8 00 00 00 00       	mov    $0x0,%eax
  801864:	eb 4c                	jmp    8018b2 <main+0x2a3>
                    }
               }
...
failed:
  ...
  80186e:	eb 28                	jmp    801898 <main+0x289>
          if (pids[i] > 0) {
  801870:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801873:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  80187a:	85 c0                	test   %eax,%eax
  80187c:	7e 16                	jle    801894 <main+0x285>
               kill(pids[i]);
  80187e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801881:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  801888:	83 ec 0c             	sub    $0xc,%esp
  80188b:	50                   	push   %eax
  80188c:	e8 76 f0 ff ff       	call   800907 <kill>
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801894:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801898:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  80189c:	7e d2                	jle    801870 <main+0x261>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
  ...
  8018a1:	68 08 1e 80 00       	push   $0x801e08
  8018a6:	6a 4e                	push   $0x4e
  8018a8:	68 13 1e 80 00       	push   $0x801e13
  8018ad:	e8 6e e7 ff ff       	call   800020 <__panic>
}
  8018b2:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8018b5:	59                   	pop    %ecx
  8018b6:	5b                   	pop    %ebx
  8018b7:	5d                   	pop    %ebp
  8018b8:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8018bb:	c3                   	ret    
